...
def imageRecognition(fname):
	...
	#textToSpeechModule.textToSpeech("Processing the image please wait!")

	#createSpeech.wait("wait2.wav")




	
	visual_recognition = VisualRecognitionV3('2017-03-12', api_key="073e34bd43d458e4c433d37cdd571d2b24d06502")
