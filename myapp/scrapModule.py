...
def getUrl():
	path="C:\\Users\\dell\\Desktop\\seProject\\seProject\\myapp\\"
	f=open(path+'credentials.json').read()
	d=json.loads(f)

	user=d['username']
	password=d['password']

	#createSpeech.wait("wait1.wav")
	...
	while(gotCorrectPage==0):
		driver.get('https://accounts.google.com/ServiceLogin?service=wise&passive=1209600&osid=1&continue=https://drive.google.com/&followup=https://drive.google.com/&emr=1#identifier')
		try:
